...
class TMR_Dress_Panel
{
    ...
    public function __construct()
    {
        ...
        add_action('wp_ajax_tmr_reorder_dress', array($this, 'ajax_reorder'));
    }
    ...
    public static function render()
    {
        ...
        TMR_Panel_Shell::header('dress', __('পোশাক', 'tailor-manager'), __('প্রতিটি পোশাকের ধরন আলাদাভাবে যোগ করুন।', 'tailor-manager'), $header_right, true);
        ?>
        ...
        jQuery(function ($) {
            ...
            TMRPanel.initSortableGrids('.tmr-dress-grid', 'tmr_reorder_dress');
    ...
    {
        ?>
        <div class="tmr-dress-card" data-id="<?php echo esc_attr($dress->ID); ?>">
