...
class TMR_Measurement_Fields_Panel
{
    ...
    public static function render()
    {
        ...
        TMR_Panel_Shell::header('measurement-fields', __('মাপের ফিল্ড ম্যানেজার', 'tailor-manager'), __('ফিল্ড তৈরি করুন, তারপর কোন পোশাকে ব্যবহার হবে তা নির্বাচন করুন।', 'tailor-manager'), $header_right, true);
        ?>
        <div class="tmr-card">
