...
class TMR_Design_Type_Panel
{
    ...
    public static function render()
    {
        ...
        TMR_Panel_Shell::header('design-type', __('ডিজাইন টাইপ ম্যানেজার', 'tailor-manager'), __('প্রতিটি ড্রেস পার্টের জন্য নির্বাচনযোগ্য ডিজাইন অপশন।', 'tailor-manager'), $header_right, true);
        ?>
        <?php if (empty($parts)) : ?>
